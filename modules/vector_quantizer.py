...
class VectorQuantizer(keras.layers.Layer):
    ...
    def call(self, x):
        ...
        a_loss = self.beta * commitment_loss + codebook_loss

        # Straight-through estimator.
        quantized = x + tf.stop_gradient(quantized - x)
        return quantized, encoding_indices, a_loss
    ...
    def get_code_indices(self, flattened_inputs):
        ...
        #maxval = tf.reduce_max(encoding_indices)
        #minval = tf.reduce_min(encoding_indices)
